<template>
  <div
    class="flex flex-wrap overflow-hidden mx-3 bg-back-white dark:bg-black dark:text-white rounded-lg shadow-md p-3"
  >
    ...
    <hr class="bg-black" />
    <div class="flex megu bg-custom-gray pr-full mt-10">
      <hr class="text-black" />
    </div>
    <div class="xl:w-1/2">
    ...
    <div class="xl:w-1/2">
      ...
      <h1 class="text-sm">
        Birth Marbella, Málaga, Andalusia, Spain Also Known As Millie Brown  Μίλι Μπόμπι Μπράουν Μίλι Μπράουν
        米莉·博比·布朗
      </h1>
    </div>
  </div>
